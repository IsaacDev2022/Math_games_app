...
class RootingTimedGameScreen extends StatefulWidget {
  const RootingTimedGameScreen({super.key});

  @override
  State<RootingTimedGameScreen> createState() => _RootingTimedGameScreenState();
}

class _RootingTimedGameScreenState extends State<RootingTimedGameScreen> {

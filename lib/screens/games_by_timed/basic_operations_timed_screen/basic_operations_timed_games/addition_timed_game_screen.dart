...
class AdditionTimedGameScreen extends StatefulWidget {
  const AdditionTimedGameScreen({super.key});

  @override
  State<AdditionTimedGameScreen> createState() => _AdditionTimedGameScreenState();
}

class _AdditionTimedGameScreenState extends State<AdditionTimedGameScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    double counterProgress = total / _timeLeft;

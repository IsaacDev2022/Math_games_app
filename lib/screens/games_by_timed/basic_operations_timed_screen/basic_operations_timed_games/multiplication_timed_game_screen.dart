...
class MultiplicationTimedGameScreen extends StatefulWidget {
  const MultiplicationTimedGameScreen({super.key});

  @override
  State<MultiplicationTimedGameScreen> createState() => _MultiplicationTimedGameScreenState();
}

class _MultiplicationTimedGameScreenState extends State<MultiplicationTimedGameScreen> {

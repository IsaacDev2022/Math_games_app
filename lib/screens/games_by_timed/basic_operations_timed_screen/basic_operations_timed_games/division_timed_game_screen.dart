...
class DivisionTimedGameScreen extends StatefulWidget {
  const DivisionTimedGameScreen({super.key});

  @override
  State<DivisionTimedGameScreen> createState() => _DivisionTimedGameScreenState();
}

class _DivisionTimedGameScreenState extends State<DivisionTimedGameScreen> {

...
class FractionDivisionTimedGameScreen extends StatefulWidget {
  const FractionDivisionTimedGameScreen({super.key});


  @override
  State<FractionDivisionTimedGameScreen> createState() => _FractionDivisionTimedGameState();

}

class _FractionDivisionTimedGameState extends State<FractionDivisionTimedGameScreen> {
  ...
  void initState() {
    super.initState();
    _startDividedTimedFractionsGame();
  }
  ...
  void _startDividedTimedFractionsGame() {
  ...
  void dividedTimedFractionsGame() {
    final progress = Provider.of<GameProgressController>(context, listen: false);
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      "${numerador1} / ${denominador1} -/- ${numerador2} / ${denominador2} = " +
                                          "${divideFractionsNumerator(numerador1, numerador2)} / " +
                                          "${divideFractionsDenominator(denominador1, denominador2)} => " +
                                          "${_result}",
                                      style: TextStyle(
                                          fontSize: 20
                                      ),
        ...
        child: Column(
          ...
          children: [
            ...
            ButtonCustom(
                ...
                textButton: "Verificar",
                color: Color(0xFF2196F3),
                onPressed: dividedTimedFractionsGame
            ),
            SizedBox(height: 20),
            if (_result.isNotEmpty)
              Text(

...
class FractionAdditionTimedGameScreen extends StatefulWidget {
  const FractionAdditionTimedGameScreen({super.key});

  @override
  State<FractionAdditionTimedGameScreen> createState() => _FractionAdditionGameTimedScreenState();
}

class _FractionAdditionGameTimedScreenState extends State<FractionAdditionTimedGameScreen> {
  ...
  void initState() {
    super.initState();
    _startAdditionTimedFractionsGame();
  }
  ...
  void _startAdditionTimedFractionsGame() {
  ...
  void additionTimedFractionsGame() {
    final progress = Provider.of<GameProgressController>(context, listen: false);
        ...
        child: Column(
          ...
          children: [
            ...
            ButtonCustom(
                ...
                textButton: "Verificar",
                color: Color(0xFF2196F3),
                onPressed: _startAdditionTimedFractionsGame
            ),
            SizedBox(height: 20),
            if (_result.isNotEmpty)
              Text(

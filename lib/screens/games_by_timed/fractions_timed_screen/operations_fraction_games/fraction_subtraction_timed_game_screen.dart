...
class _FractionSubtractionGameScreenState extends State<FractionSubtractionGameScreen> {
  ...
  void initState() {
    super.initState();
    _startSubtractionTimedFractionsGame();
  }
  ...
  void _startSubtractionTimedFractionsGame() {
  ...
  void subtractTimedFractionsGame() {
    final progress = Provider.of<GameProgressController>(context, listen: false);
        ...
        child: Column(
          ...
          children: [
            ...
            ButtonCustom(
                ...
                textButton: "Verificar",
                color: Color(0xFF2196F3),
                onPressed: subtractTimedFractionsGame
            ),
            SizedBox(height: 20),
            if (_result.isNotEmpty)
              Text(
